...
if not TOKEN:
    raise ValueError("⚠️ BOT_TOKEN topilmadi! Railway > Variables bo'limiga tokenni qo'shing.")
...
def download_media(url: str, user_id: int, mode: str) -> str:
    ...
    for ext in ("mp4", "mp3", "m4a", "webm", "mkv"):
        ...
        if os.path.exists(path):
            return path    raise FileNotFoundError("Video topilmadi yoki yuklashda xato bo'ldi")
